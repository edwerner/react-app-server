        ...
        <div>
            ...
            <div className="form-group">
                ...
                <div className="col-lg-10">
                    <input onChange={this.onEmailChange} type="text" className="span2 form-control" id="email" placeholder="Email address"/>
                    <span className="help-block">Incorrect email</span>
                </div>
            </div>
            <div className="form-group">
                <label className="col-lg-2 control-label">Password</label>
                <div className="col-lg-10">
                    <input onChange={this.onPasswordChange} type="password" className="span2 form-control" id="password" placeholder="Password"/>
                    <span className="help-block">Incorrect password</span>
                </div>
            </div>
            <div className="form-group">
